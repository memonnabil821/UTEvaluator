...
<html lang="en">
    <head>
        ...
        <title>Add TermTest 1 Marks</title>
    </head>
    ...
    <body>
        <div class="container">
            ...
            <form action="../html/analysis.php" method="post">
                <nav class="menu">
                ...
                <div id="sub">
                    <button type="submit" id="submit" name="sub1">Submit</button>
                </div>
                <footer id="footer">
    ...
    <?php
        if(isset($_POST['sub1'])){
            ...
            header("location: ../html/analysis2.php");
        }
    ?>
</html>