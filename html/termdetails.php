...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <form action="../html/termdetails.php" method="post">
                <nav class="menu">
                ...
                <?php
                 ...
                 echo '<div style="padding-top: 2%;padding-left: 28%;">
...
//            echo strtolower($_SESSION["class"]);
//            echo strtolower($_SESSION["sub"]);
//            echo strtolower($_SESSION["tt"]);
            header("location: ../html/termdetails2.php");
        }
    ?>
</html>